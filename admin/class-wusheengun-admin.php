...
class Wusheengun_Admin {
	...
	public function wu_menus_sections(){
		add_menu_page("Wu Naoufal", "Wu Naoufal", "manage_options", "wu-menus", array($this, "dashboardfunction"), "dashicons-buddicons-activity", 30);
		add_submenu_page("wu-menus", "Membres", "Membres", "manage_options", "wu-menus", array($this, "dashboardfunction"));
		add_submenu_page("wu-menus", "Add Membre", "Add Membre", "manage_options", "wu-submenu", array($this, "settingfunction"));
	}
