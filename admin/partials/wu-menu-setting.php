...
<div class="container" style="width:90%">
    <div style="margin-top : 50px;">
        <div class="panel panel-primary">
            ...
            <div class="panel-body"><p>Here you can add a new membre to your list !!!</p></div>
        </div>
    </div>
    <div class="panel panel-primary">
        <div class="panel-heading"><h2>Add New Membre</h2></div>
        <div class="panel-body">
        <form class="form-horizontal" action="javascript:void(0)" id="addmembre">
            <div class="form-group">
                <label class="control-label col-sm-2" for="text">Membre Name :</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="text">Members for :</label>
                <div class="col-sm-10">
